...
#define CHECK_VALID_VIR_PAGE_NUM 5          //要检查的有效虚拟页的数量
#define BEING_CHECK_VALID_VADDR 0X1000
#define CHECK_VALID_VADDR (CHECK_VALID_VIR_PAGE_NUM+1)*0x1000       //定义有效虚拟地址的范围
// the max number of valid physical page for check
#define CHECK_VALID_PHY_PAGE_NUM 4          //要检查的有效物理页的数量
// the max access seq number
#define MAX_SEQ_NO 10                       //最大访问序列号的数量
...
//初始化页面交换管理器，并根据其初始化结果设置 swap_init_ok 全局变量。
int
swap_init(void)
{
     swapfs_init();
